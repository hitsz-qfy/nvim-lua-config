...
_G.packer_plugins = {
  ...
  ["cmp-buffer"] = {
    loaded = true,
    path = "/home/qfy/.local/share/nvim/site/pack/packer/start/cmp-buffer"
  },
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/qfy/.local/share/nvim/site/pack/packer/start/cmp-cmdline"
  },
  ["cmp-nvim-lsp"] = {
    loaded = true,
  ...
  ["cmp-path"] = {
    loaded = true,
    path = "/home/qfy/.local/share/nvim/site/pack/packer/start/cmp-path"
  },
  cmp_luasnip = {
    loaded = true,
